...
while game:
    ...
    collision1 = pygame.sprite.spritecollide(balloon, all_eagles, True)
    for eagle in collision1:
        e = Eagle1(eagle1_img)
        all_sprites.add(e)
        all_eagles.add(e)    
        balloon.kill()
    ...
    collision2 = pygame.sprite.spritecollide(balloon, all_eagles, True)
    for eagle in collision2:
        e = Eagle2(eagle1_img)
        all_sprites.add(e) 
        all_eagles.add(e)   
        balloon.kill()
